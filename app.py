...
# API Key handling (use Streamlit secrets for deployment)
openai_api_key = st.secrets.get("OPENAI_API_KEY") or os.getenv("OPENAI_API_KEY")
if not openai_api_key:
    st.error("OpenAI API key not found. Set it in Streamlit secrets or environment variables.")
    st.stop()

# LLM setup
llm = ChatOpenAI(
    model="gpt-4o-mini",  # Use a suitable model; you can change to gpt-3.5-turbo for cost
...
if generate_button and theme:
    ...
    # Optional: Display intermediate results if needed
